...
class SignUpPageState extends State<SignUpPage> {
  ...
  void initState() {
    ...
    twilioFlutter = TwilioFlutter(accountSid: env.twilioAccountSid, authToken: env.twilioAuthToken, twilioNumber: env.twilioNumber);
  }
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
        child: Scaffold(
            body: Stack(children: [
          Image.asset('assets/images/login/resold-app-loginpage-background.jpg', fit: BoxFit.cover, alignment: Alignment.topCenter, width: 500),
          SingleChildScrollView(
            ...
            Center(
              ...
              RaisedButton(
                ...
                child: Text('Sign Up', style: new TextStyle(fontSize: 20.0, fontWeight: FontWeight.bold, color: Colors.white)),
