                      ...
                      decoration: InputDecoration(
                          ...
                          enabledBorder: UnderlineInputBorder(
                              borderSide: BorderSide(
                                  color: listingTitleController.text.isNotEmpty ? ResoldBlue : Colors.black,
                                  width: 1.5)),
                ...
                Padding(
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                        ...
                        enabledBorder: UnderlineInputBorder(
                            borderSide: BorderSide(
                                color: priceController.text.isNotEmpty ? ResoldBlue : Colors.black, width: 1.5)),
                        focusedBorder: UnderlineInputBorder(borderSide: BorderSide(color: ResoldBlue, width: 1.5))),
                    validator: (value) {
                      if (value.isEmpty) {
                ...
                Padding(
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      enabledBorder: UnderlineInputBorder(
                          borderSide: BorderSide(
                              color: detailsController.text.isNotEmpty ? ResoldBlue : Colors.black, width: 1.5)),
                      focusedBorder: UnderlineInputBorder(borderSide: BorderSide(color: ResoldBlue, width: 1.5)),
                    ),
                    validator: (value) {
                      if (value.isEmpty) {
                      ...
                      onPressed: () async {
                        if (formKey.currentState.validate()) {
                          ...
                          Product product = Product(
                              ...
                              categoryIds: [
                                int.tryParse(CategoryHelper.getCategoryIdByMatrix(sellState.selectedCategory))
                              ],
