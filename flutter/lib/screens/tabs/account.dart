...
class AccountPage extends StatefulWidget {
  ...
  AccountPage(int vendorId, {Key key})
      : vendorId = vendorId,
        super(key: key);

  @override
  AccountPageState createState() => AccountPageState(vendorId);
}
...
class AccountPageState extends State<AccountPage> {
  ...
  AccountPageState(this.vendorId);

  @override
  void initState() {
    super.initState();
    futureForSaleVendorProducts = Resold.getVendorProducts(vendorId, 'for-sale');
    futureSoldVendorProducts = Resold.getVendorProducts(vendorId, 'sold');
    futureVendor = Resold.getVendor(vendorId);
                            ...
                            Column(children: [
                              ...
                              ButtonTheme(
                                  ...
                                  child: RaisedButton(
                                    ...
                                    onPressed: () async {
                                      Navigator.push(
                                              context, MaterialPageRoute(builder: (context) => EditProPage(customer)))
                                          .then((value) => {
                                                setState(() {
                                                  imageCache.clear();
