                                          ...
                                          return showDialog<void> (
                                            ...
                                            builder: (BuildContext context) {
                                              return AlertDialog (
                                                ...
                                                content: Text("Is yo phone number correct?",),
                                                actions: <Widget> [
                                                  FlatButton(
                                                    child: Text('Ok',
      ...
      builder: (BuildContext context) {
        return AlertDialog (
          ...
          content: SingleChildScrollView(
            child: ListBody(
              children: <Widget>[
                Text("Confrim your current password to update your profile.",),
                Form(
                  key: updateKey1,
                  child: TextFormField(
        ...
        builder: (BuildContext context) {
          return AlertDialog (
            ...
            content: SingleChildScrollView(
              child: ListBody(
                children: <Widget>[
                  Text("Do you want this to be your new profile picture?",),
                  Container(
                    height: 115,
                    width: 115,
                    child: Padding(
                  ...
                  if (deleteKey.currentState.validate()) {
                    ...
                    if (await complete){ 
                      ...
                      return showDialog<void>(
                        ...
                        builder: (BuildContext context) {
                          return AlertDialog(
                            title: Text("Your profile has been deleted."),
                            actions: <Widget>[
                              FlatButton(
                                child: Text('Ok',
                                  style: TextStyle(color: ResoldBlue),
