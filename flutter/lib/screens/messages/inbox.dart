...
class InboxPage extends StatefulWidget {
  InboxPage(customer, {Key key}) : super(key: key);
                          ...
                          builder: (context, snapshot) {
                            if (!snapshot.hasData) {
                              ...
                              messages.sort((DocumentSnapshot a, DocumentSnapshot b) {
                                var dateA =
                                    new DateTime.fromMillisecondsSinceEpoch(int.parse(a['lastMessageTimestamp']));
                                var dateB =
                                    new DateTime.fromMillisecondsSinceEpoch(int.parse(b['lastMessageTimestamp']));
