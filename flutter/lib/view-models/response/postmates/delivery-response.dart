...
class DeliveryResponse extends Response {
  ...
  final String
      status; // delivery status, see: https://postmates.com/developer/docs/#resources__delivery__create-delivery
  ...
  DeliveryResponse(
      ...
      this.currency,
      this.courier,
      this.courier_imminent,
      this.dropoff,
      this.dropoff_deadline,
      this.dropoff_eta,
      this.dropoff_identifier,
      this.dropoff_ready,
      this.pickup,
      this.pickup_deadline,
      this.pickup_eta,
      this.pickup_ready,
      this.manifest,
      this.manifest_items,
      ...
      this.tip,
      this.tracking_url,
      this.undeliverable_action,
      this.undeliverable_reason,
      this.uuid,
      statusCode,
      error})
