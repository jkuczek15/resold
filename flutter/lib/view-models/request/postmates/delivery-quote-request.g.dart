...
DeliveryQuoteRequest _$DeliveryQuoteRequestFromJson(Map<String, dynamic> json) {
  return DeliveryQuoteRequest(
    ...
    dropoff_deadline_dt: json['dropoff_deadline_dt'] == null
        ? null
        : DateTime.parse(json['dropoff_deadline_dt'] as String),
    ...
    dropoff_ready_dt: json['dropoff_ready_dt'] == null
        ? null
        : DateTime.parse(json['dropoff_ready_dt'] as String),
    pickup_deadline_dt: json['pickup_deadline_dt'] == null
        ? null
        : DateTime.parse(json['pickup_deadline_dt'] as String),
    ...
    pickup_ready_dt: json['pickup_ready_dt'] == null
        ? null
        : DateTime.parse(json['pickup_ready_dt'] as String),
  );
}
