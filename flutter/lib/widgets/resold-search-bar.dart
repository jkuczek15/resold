...
mixin _ControllerListener<T> on State<ResoldSearchBar<T>> {
...
class ResoldSearchBar<T> extends StatefulWidget {
...
class _SearchBarState<T> extends State<ResoldSearchBar<T>> with TickerProviderStateMixin, _ControllerListener<T> {
  bool _loading = false;
  Widget _error;
  ...
  void initState() {
    ...
    _searchQueryController = widget.textEditingController ?? TextEditingController();
  }
