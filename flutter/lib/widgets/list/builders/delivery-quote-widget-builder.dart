...
class DeliveryQuoteWidgetBuilder {
  static Widget buildDeliveryQuoteWidget(CustomerResponse customer, List<FirebaseDeliveryQuote> quotes,
      {String error}) {
    if (quotes.length == 0) {
    ...
    return SingleChildScrollView(
      ...
      children: <Widget>[
        Container(
          ...
          if (quotes.length > 0) DeliveryQuoteList(customer: customer, quotes: quotes),
        ]))
      ],
    ));
