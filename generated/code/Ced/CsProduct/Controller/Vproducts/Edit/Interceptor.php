...
class Interceptor extends \Ced\CsProduct\Controller\Vproducts\Edit implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $this->___init();
        parent::__construct($context, $productBuilder, $customerSession, $stockFilter, $resultPageFactory, $urlFactory, $resultForwardFactory, $moduleManager, $scopeConfig, $storeManager);
    }
