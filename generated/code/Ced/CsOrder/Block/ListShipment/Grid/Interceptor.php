<?php
namespace Ced\CsOrder\Block\ListShipment\Grid;

/**
 * Interceptor class for @see \Ced\CsOrder\Block\ListShipment\Grid
 */
class Interceptor extends \Ced\CsOrder\Block\ListShipment\Grid implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $this->___init();
        parent::__construct($context, $backendHelper, $vordersFactory, $moduleManager, $pageLayoutBuilder, $invoice, $resource, $vorders, $helperData, $objectManager, $customerSession, $data);
    }
