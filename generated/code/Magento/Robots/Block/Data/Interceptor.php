...
class Interceptor extends \Magento\Robots\Block\Data implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Framework\View\Element\Context $context, \Magento\Robots\Model\Robots $robots, \Magento\Store\Model\StoreResolver $storeResolver, array $data = [])
    {
        $this->___init();
