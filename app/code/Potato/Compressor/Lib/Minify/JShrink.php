<?php
namespace Potato\Compressor\Lib\Minify;
/*
 ...
 * Minifier
 *
 * Usage - PotatoCommerce_Compressor_Minify_JShrink::minify($js);
 * Usage - PotatoCommerce_Compressor_Minify_JShrink::minify($js, $options);
 * Usage - PotatoCommerce_Compressor_Minify_JShrink::minify($js, array('flaggedComments' => false));
 *
 * @package JShrink
 * @author Robert Hafner <tedivm@tedivm.com>
...
class JShrink
{
    ...
    protected function getReal()
    {
        ...
        $this->c = $oneLineCheck = $this->getChar();
        if ($this->c === '*') {
            $oneLineCheck = $char = $this->processMultiLineComments($startIndex);
        }
        if ($oneLineCheck === '/') {
