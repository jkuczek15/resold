...
class MassStatus extends \Magento\Catalog\Controller\Adminhtml\Product
{
    ...
    {   
        ...
        $status = (int) $this->getRequest()->getParam('is_facebook');
        ...
        try {
            ...
            $this->_objectManager->get('Magento\Catalog\Model\Product\Action')
                ->updateAttributes($productIds, ['is_facebook' => $status], $storeId);
        ...
        return $resultRedirect->setPath('facebook/*/', ['store' => $storeId]);
    }
}
