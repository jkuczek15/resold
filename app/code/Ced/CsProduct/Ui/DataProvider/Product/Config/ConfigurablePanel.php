...
class ConfigurablePanel extends AbstractModifier
{
    ...
    {
        if($this->request->getParam('type')!='configurable')
            return $meta;
            ...
            'arguments' => [
                'data' => [
                    'config' => [
                        ...
                        'component' => 'Ced_CsProduct/js/components/dynamic-rows-configurable',
                        'addButton' => false,
                        'isEmpty' => true,
                        'itemTemplate' => 'record',
                        'dataScope' => 'data',
                ...
                'children' => [
                    'thumbnail_image_container' => $this->getColumn(
                        ...
                        [
                            ...
                            'elementTmpl' => 'Ced_CsProduct/components/file-uploader',
                            'fileInputName' => 'image',
                            ...
                            'uploaderConfig' => [
                                'url' => $this->urlBuilder->addSessionParam()->getUrl(
                                    'csproduct/product_gallery/upload'
                                ),
                            ],
                            'dataScope' => 'image',
                        ],
                        ...
                        'arguments' => [
                            'data' => [
                                'config' => [
                                    ...
                                    'template' => 'Ced_CsProduct/components/cell-status',
                                    'label' => __('Status'),
                                    'dataScope' => 'status',
                                ],
                            ],
                        ...
                        'arguments' => [
                            'data' => [
                                'config' => [
                                    ...
                                    'componentType' => 'text',
                                    'component' => 'Magento_Ui/js/form/element/abstract',
                                    'template' => 'Ced_CsProduct/components/actions-list',
                                    'label' => __('Actions'),
                                    'fit' => true,
                                    'dataScope' => 'status',
                                ],
    ...
    protected function getColumn(
        ...
        $fieldText['arguments']['data']['config'] = [
            'componentType' => Form\Field::NAME,
            'formElement' => Form\Element\Input::NAME,
            'elementTmpl' => 'Ced_CsProduct/components/cell-html',
            'dataType' => Form\Element\DataType\Text::NAME,
            'dataScope' => $name,
